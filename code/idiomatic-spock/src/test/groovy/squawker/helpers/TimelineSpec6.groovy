...
abstract class TimelineSpec6 extends Specification {
  ...
  static class ReturnsBoolean extends TimelineSpec6 {
  ...
  static class WithAssertKeyword extends TimelineSpec6 {
